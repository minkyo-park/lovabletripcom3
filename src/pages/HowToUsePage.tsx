...
const HowToUsePage = () => (
  <>
    <Head>
      <title>사용방법 가이드 - 트립닷컴 쿠폰</title>
      <meta name="description" content="트립닷컴 쿠폰 적용 방법을 웹/앱별로 상세 안내합니다. 할인코드가 적용되지 않을 때 해결 방법, 결제 수수료 절약법, 결제 통화 설정까지 한 번에 확인하세요." />
      <link rel="canonical" href="https://trip.couponmonster.co.kr/how-to-use" />
      <meta property="og:type" content="article" />
      <meta property="og:title" content="사용방법 가이드 - 트립닷컴 쿠폰" />
      <meta property="og:description" content="트립닷컴 쿠폰 적용 방법을 웹/앱별로 상세 안내합니다. 할인코드가 적용되지 않을 때 해결 방법, 결제 수수료 절약법, 결제 통화 설정까지 한 번에 확인하세요." />
      ...
      <meta name="twitter:title" content="사용방법 가이드 - 트립닷컴 쿠폰" />
      <meta name="twitter:description" content="트립닷컴 쿠폰 적용 방법을 웹/앱별로 상세 안내합니다. 할인코드가 적용되지 않을 때 해결 방법, 결제 수수료 절약법, 결제 통화 설정까지 한 번에 확인하세요." />
      <meta name="twitter:image" content="https://trip.couponmonster.co.kr/images/og-image.jpg" />
      <script type="application/ld+json">{JSON.stringify({
        "@context": "https://schema.org",
        "@type": "HowTo",
        "name": "트립닷컴 쿠폰 사용 방법",
        "description": "트립닷컴 쿠폰을 웹과 앱에서 적용하는 방법",
        "step": [
