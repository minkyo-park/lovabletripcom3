...
const GuidePage = () => (
  <>
    <Head>
      ...
      <meta property="og:title" content="할인 완벽 가이드 - 트립닷컴 쿠폰" />
      ...
      <meta name="twitter:title" content="할인 완벽 가이드 - 트립닷컴 쿠폰" />
    ...
    <main className="max-w-6xl mx-auto px-4 py-12">
            ...
            <table className="responsive-table table-as-cards">
              ...
              <tbody>
                {[
                  ...
                  { card: "네이버웨일", rate: "7%", currency: "USD", period: "~2026.09.30", stars: "★★★★★", badge: null },
                  { card: "KB국민카드", rate: "최대 6%", currency: "USD", period: "~2026.12.31", stars: "★★★★☆", badge: null },
                  { card: "우리카드", rate: "6%", currency: "USD", period: "~2026.09.30", stars: "★★★★☆", badge: null },
                  { card: "BC카드", rate: "6%", currency: "KRW", period: "~2026.09.30", stars: "★★★★☆", badge: "KRW 가능" },
      ...
      <section className="mb-16" aria-labelledby="period-concept">
        ...
        <div className="section-card mt-4 bg-secondary">
          ...
          <p className="text-xs text-muted-foreground">예약기간: 9월 1일 ~ 9월 30일 / 숙박기간: 10월 1일 ~ 12월 31일<br />→ 반드시 9월 중에 할인코드를 입력하여 예약 완료해야 합니다.<br />→ 9월 30일 이후에는 할인코드 사용 예약 불가.</p>
        </div>
      </section>
